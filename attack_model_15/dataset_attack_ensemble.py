...
tweet_path2 = pth.join('../load_data15_1473/ensemble_attack/comments_text_encode3.csv')
tree_dict_path = pth.join('../load_data15_1473/ensemble_attack/tree_dictionary.json')

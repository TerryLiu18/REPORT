...
class Net(nn.Module):
    ...
    def __init__(self, args, tweet_embedding_matrix):
        ...
        self.fc = nn.Linear(self.tree_hidden_size1 + self.tree_hidden_size2, 4)
        
    def forward(self, user_feats, graph_node_features, graph_edge_index, merged_tree_feature, merged_tree_edge_index, indices):
        user_root_embed = self.graphGCN(user_feats, graph_node_features, graph_edge_index, indices)

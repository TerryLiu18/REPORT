...
parser.add_argument('--patience', default=8, type=int, help='how long to wait after last time validation loss improved')
...
def _train_model():
    ...
    for epoch in range(curr_epoch, args.epoches):
        ...
        Acc_all, Acc1, Prec1, Recll1, F1, Acc2, Prec2, Recll2, F2, Acc3, Prec3, Recll3, F3, Acc4, Prec4, Recll4, F4 = _testing_model()
...
if __name__ == '__main__':
    ...
    TWEETS_WORD_FILE = pth.join('../load_data15/tweets_words_mapping.json')

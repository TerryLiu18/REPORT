...
tweet_path2 = pth.join('../load_data15/comments_text_encode3.csv')
...
user_filepath2 = pth.join('../load_data15/filtered_user_profile4_encode2.csv')
...
"""
graph_connection_path = '../load_data15/graph_connections4.json'

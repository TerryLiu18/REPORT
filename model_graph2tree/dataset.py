...
class TwitterDataset(Dataset):
    ...
    def get_tweet_graph(self, index):
        ...
        # source_user_id = self.source_tweet_df.loc[index, 'user_id']
        # text = self.source_tweet_df.loc[index, 'text']
        # graph_tweet = {
        #     'node_id': tweet_node_id,
        #     'text': eval(tweet_info['text']),

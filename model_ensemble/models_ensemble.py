...
class GraphGCN(nn.Module):
    ...
    def forward(self, user_text, user_feats, graph_node_features, graph_edge_index, indices):
...
class Net(nn.Module):
    ...
    def __init__(self, args, tweet_embedding_matrix, user_embedding_matrix, direction='td'):

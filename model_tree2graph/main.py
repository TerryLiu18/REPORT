...
from models_tree2graph import Net
...
# parser.add_argument('--tree_hidden_size3', default=50, type=int, help='hidden size for treeGCN')
...
# parser.add_argument('--graph_hidden_size3', default=100, type=int, help='hidden size for graphGCN')

parser.add_argument('--direction', default='bu', type=str, help='tree direction: topdown(td)/bottomup(bu)')
...
if __name__ == '__main__':
    ...
    user_embedding_matrix = 0 # currently not used
    ...
    #     dict(params=model.graphGCN.conv1.parameters(), weight_decay=5e-4),
    #     dict(params=model.graphGCN.conv2.parameters(), weight_decay=0)
    # ], lr=0.01)  # Only perform weight-decay on first convolution.

    optimizer = torch.optim.Adam([
        dict(params=model.graphGCN.conv1.parameters(), weight_decay=5e-5),
        dict(params=model.graphGCN.conv2.parameters(), weight_decay=0)

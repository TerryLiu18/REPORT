...
class graphGCN(nn.Module):
    ...
    def forward(self, user_text, user_feats, graph_node_features, graph_edge_index, tree_embed, indices):
...
class Net(nn.Module):
    ...
    def forward(self, user_text, user_feats, graph_node_features, graph_edge_index, merged_tree_feature, merged_tree_edge_index, indices):
        ...
        graph_root_embed = self.graphGCN(user_text, user_feats, graph_node_features, graph_edge_index, tree_embed, indices)

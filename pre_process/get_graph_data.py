...
# from pre_process.user_profile_processing import *
# from pre_process.tweet_profile_processing import *
# from pre_process.batch_input_process import *
...
max_tweet_index = tweet_num - 1  # 1309
...
# edge_idx: [[], ...]
# edge_index: 2D np Array

# get tweet_user_dict from user_tweet_dict
...
# def check_edge_connection(edge_idx) -> "edge_idx: [[], ...]":

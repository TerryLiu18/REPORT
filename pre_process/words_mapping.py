...
def _data_normalize(df):
    ...
    list_cols = ['statuses_count', 'favourites_count', 'listed_count', 'followers_count', 'friends_count', 'year', 'month', 'day','hour']
...
def main():
    ...
    print(dir_path)
    # save_dir = os.path.join(dir_path, 'datasets/twitter15/word_set')
    # _path = 'datasets/'+ task.dataset +'/word_set'
    save_dir = os.path.join(dir_path, 'datasets/twitter16/word_set')
    if not os.path.isdir(save_dir):
        os.mkdir(save_dir)

    # file_path = 'load_data15/filtered_user_profile.csv'
    file_path = os.path.join('load_data16/filtered_user_profile.csv')
    ...
    out_file = 'load_data/filtered_user_profile_words_mapping.json'
    out_file = 'load_data16/filtered_user_profile_words_mapping.json'
    ...
    out_file = 'load_data/tweets_words_mapping.json'

...
def main():
    ...
    print(dir_path)
    file_path = os.path.join('load_data15/filtered_user_profile{}.csv'.format(str(filter_num)))
    ...
    out_file = 'load_data15/filtered_user_profile_words_mapping{}.json'.format(str(filter_num))
    ...
    out_file = os.path.join(
        dir_path, 'load_data15/filtered_user_profile{}_encode1.csv'.format(str(filter_num))
    )
    ...
    tweet_file = os.path.join('../load_data15/comments_text.csv')
    ...
    out_file = 'load_data15/tweets_words_mapping.json'
    out_file = os.path.join(dir_path, out_file)
    word2index = _map_word2index(words_set, out_file)
    ...
    max_len = np.percentile(sent_len, 99)
    out_file = os.path.join(
        dir_path, 'load_data15/comments_text_encode1.csv'
    )

...
original_tree_dir = pth.join('../datasets/twitter16/raw_data/tweet_tree')
tweet_dir = pth.join('../datasets/twitter16/raw_data/tweet_profile')
user_dir = pth.join('../datasets/twitter16/raw_data/user_profile')
available_tweet_set = set()
available_user_set = set()

# get all available tweet_set
tweet_set_path = pth.join('../datasets/twitter16/auxiliary_data/available_tweet_set.txt')
...
user_set_path = pth.join('../datasets/twitter16/auxiliary_data/available_user_set.txt')
